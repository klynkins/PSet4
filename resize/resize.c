...
int main(int argc, char *argv[])
{
    ...
    //modify the header before writing to outptr
    //new file headers
    ...
    for (int i = 0, biHeight = abs(bi.biHeight); i < biHeight; i++)
    {
        ...
        // then add it back (to demonstrate how) and add new padding
        ...
        if (repeat < n-1)
        {
            fseek(inptr, -(bi.biWidth * 3 /* sizeof(RGBTRIPLE) */ + padding), SEEK_CUR);
        }
    }
    }
